...
class gcca(metric):
    ...
    def solve(self):
        ...
        print("#number_of_views_gcca:",number_of_views)
        # cal G
        self.solve_g()
#        print (type(self.G))
        ...
        # np.save("./gcca_data/W_list_gcca_origin.npy",self.list_U)
        # print("#debug:",self.list_U[0].shape)
...
#    np.save("../gcca_data/W_list_gcca_origin.npy",clf.list_U)
    #
